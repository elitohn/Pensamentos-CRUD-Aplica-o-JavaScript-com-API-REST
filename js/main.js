...
const regexConteudo = /^[A-Za-zÀ-ÿ0-9\s.,!?'"-]{10,}$/
...
async function manipularSubmissaoFormulario(event) {
  ...
  if(!validarConteudo(conteudo.trim())) {
    alert("É permitida apenas a inclusão apenas de letras e espaços com no mínimo 10 caracteres")
    return
  }
  ...
  if(!id && pensamentosSet.has(chaveNovoPensamento)) {
